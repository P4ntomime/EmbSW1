...
\setcounter{tocdepth}{3}            % only display sections and subsections in toc
...
\dottedcontents{subsection}[4em]{}{3em}{.5pc}
\dottedcontents{subsubsection}[5.5em]{\slshape}{3.5em}{.25pc}
...
% FIXME: weird behavior within description environment. Offsets first line if it's the first element of said line... why???
\newtcbox{\mybox}
            [1]
            [backcolour]
            {on line,
...
%   === Size and Margin Setup ===
    ...
    xleftmargin=3ex,      % Left margin set to 2.5ex          % XXX: xleftmargin needs to be extended if line numbers reach 100
%   === Line Number Formatting ===
    numbers=left,   % Line numbers on the left
    numbersep=3pt,  % Separation between line numbers and code
%   === Encoding Setup ===
...
\lstdefinestyle{cppstyle}{%
    ...
    escapeinside={(*@}{@*)},  % inline latex commands
...
%       === cstddef (stddef.h) ===
    ...
    keywordstyle={[3]\color{green!70!blue}}, % [3] generates a third keyword style group
