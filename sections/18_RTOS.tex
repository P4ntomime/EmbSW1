...
\scalebox{0.795}{
    \begin{tabular}{lll}
        ...
        \midrule
        \rowcolor{gray!25} \textbf{Leichtgewichtigkeit}         & Sehr leichtgewichtig                      & Ressourceninvensiver                      \\
        \textbf{Feature-Set}                                    & Grundlegende RTOS-Funktionalitäten        & Umfangreicher (Treiber, Netzwerk, FS)     \\
        \rowcolor{gray!25} \textbf{Hardware-Support}            & Sehr breit                                & Begrenzter, aber wachsender Support       \\
        \textbf{Lernkurve}                                      & Einfach und schnell                       & Anspruchsvoller, aber leistungsfähiger    \\
        \rowcolor{gray!25} \textbf{Einsatzgebiete}              & Kleinere, spezifische Projekte            & Skalierbare \& komplexere Anwendungen     \\
...
\scalebox{0.97}{
    \begin{tabular}{lll}
        ...
        \midrule
        \rowcolor{gray!25} \textbf{Sensorsteuerung}                             & gut umsetzbar             & gut umsetzbar         \\
        \textbf{IoT-Gerät mit WLAN}                                             & gut umsetzbar             & gut umsetzbar         \\
        \rowcolor{gray!25} \textbf{Komplexeres IoT-Gerät (Bluetooth + FS)}      & schwierig umzusetzen      & gut umsetzbar         \\
