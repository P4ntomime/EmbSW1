...
% TODO: Reformatting / adjustments according to new slides 
% better sectioning with paragraphs -> 1 paragraph per slide
...
\begin{outline}
    \1 Jeder client meldet beim server an, welche Ereignisse ihn interessieren
        ...
        \lstinputlisting[aboveskip=1mm, linewidth=\linewidth,morekeywords={[3], e, f}, firstnumber=1, firstline=1, lastline=4]{snippets/ebs_callback.c}
...
\para{Event austragen}

% TODO: slide 13


\subsection{Code-Beispiele zu Callback-Funktionen} 
%TODO: reorganize with new slides
