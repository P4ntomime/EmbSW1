...
Mehrere (gleiche oder unterschiedliche) Tasks müssen erledigt werden. Dazu werden Ressourcen benötigt (z.B. \textbf{CPU}, Speicher, \ldots).
...
Eine Menge von Tasks ist dann \textbf{schedulable}, wenn \textbf{alle Tasks zu allen Zeiten ihre deadlines einhalten} können. 
...
RMS beschreibt Regel, bei deren Einhaltung eine Konfiguration \textbf{immer schedulable} ist.
...
Jede Konfiguration mit $n$ periodischen Tasks ist \textbf{immer} RM schedulable, wenn die Gesamtauslastung $U$ 
