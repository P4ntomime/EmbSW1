...
\lstinputlisting[aboveskip=1mm, belowskip=0mm, morekeywords={[3], currentState, initValue, e}, morekeywords={[2], State, cnt_Event}]{snippets/fsm_procedural_C/fsm_counterCtrl_C.c}
...
\begin{center}
    \includegraphics[width=0.8\columnwidth]{images/fsm_up-down-counter_diagramm_CPP.png}
\end{center}
...
\para{Implementation FSM} 
\lstinputlisting[aboveskip=1mm, belowskip=0mm, lastline=28, morekeywords={[3], initValue, e, myCounter, currentState}, morekeywords={[2], Event, State, Counter}]{snippets/fsm_procedural_CPP/fsm_CounterCtrl_CPP.cpp}
\columnbreak
...
\para{Schnittstelle FSM} 
\lstinputlisting[aboveskip=1mm, belowskip=0mm, morekeywords={[3], initValue, e, myCounter, currentState, ev, pAction, nextState}, morekeywords={[2], Event, State, Action, Transition}]{snippets/fsm_table_CPP/fsm_CounterCtrl_table_CPP.h} 

\columnbreak

\para{Implementation FSM} 
\lstinputlisting[aboveskip=1mm, belowskip=0mm, morekeywords={[3], initValue, e, myCounter, currentState, i}, morekeywords={[2], Event, State, Action, Transition}]{snippets/fsm_table_CPP/fsm_CounterCtrl_table_CPP.cpp}
