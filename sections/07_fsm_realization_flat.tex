...
\begin{outline}
    ...
    \1 Bei mehreren Instanzen in C\ldots
...
% \lstinputlisting[xleftmargin=3ex, aboveskip=0mm, belowskip=0mm, firstline=21, firstnumber=21,
%                  morekeywords={[3], currentState, initValue, e}, morekeywords={[2], State, cnt_Event}]
%                 {snippets/fsm_procedural_C/fsm_counterCtrl_C.c}

\para{Anstossen der FSM} 
\lstinputlisting[xleftmargin=3ex, aboveskip=1mm, belowskip=0mm, morekeywords={[3], answer}]{snippets/fsm_procedural_C/fsm_main_counterTest_C.c}
...
\para{Schnittstelle FSM} 
\lstinputlisting[aboveskip=1mm, belowskip=0mm, morekeywords={[3], initValue, e, myCounter, currentState}, morekeywords={[2], Event, State, Counter}]{snippets/fsm_procedural_CPP/fsm_CounterCtrl_CPP.h} 
% \columnbreak
% \lstinputlisting[xleftmargin=3ex, aboveskip=0mm, belowskip=0mm, firstline=22, firstnumber=22, morekeywords={[3], initValue, e, myCounter, currentState}, morekeywords={[2], Event, State, Counter}]{snippets/fsm_procedural_CPP/fsm_CounterCtrl_CPP.h} 

\para{Implementation FSM} 
\lstinputlisting[xleftmargin=3ex, aboveskip=1mm, belowskip=0mm, morekeywords={[3], initValue, e, myCounter, currentState}, morekeywords={[2], Event, State, Counter}]{snippets/fsm_procedural_CPP/fsm_CounterCtrl_CPP.cpp}
...
\para{Anstossen der FSM} 
\lstinputlisting[xleftmargin=3ex, aboveskip=1mm, belowskip=0mm, morekeywords={[3], answer, myFSM}, morekeywords={[2], CounterCtrl}]{snippets/fsm_procedural_CPP/fsm_main_counterTest_CPP.cpp}
...
\para{Schnittstelle FSM} 
\lstinputlisting[aboveskip=1mm, belowskip=0mm, morekeywords={[3], initValue, e, myCounter, currentState, ev, pAction, nextState, fsm}, morekeywords={[2], Event, State, Action, Transition, Counter}]{snippets/fsm_table_CPP/fsm_CounterCtrl_table_CPP.h} 
% \columnbreak
...
\begin{enumerate}
    \item Transitionen könnten in der \texttt{Context}-Klasse definiert werden. \\
    ...
    \item \texttt{State}-Klassen \textbf{realisieren ihre Transitionen selbst.} \\
