...
\begin{minipage}[t]{0.48\columnwidth}
    ...
    \lstinputlisting[aboveskip=0mm]{snippets/fsm_procedural_C/fsm_counter_C.h}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\columnwidth}
    \para{Implementation Counter} 
    \lstinputlisting[aboveskip=0mm]{snippets/fsm_procedural_C/fsm_counter_C.c}
\end{minipage}
...
\lstinputlisting[aboveskip=0mm]{snippets/fsm_procedural_C/fsm_counterCtrl_C.h} 

\para{Implementation FSM} 
\lstinputlisting[aboveskip=0mm]{snippets/fsm_procedural_C/fsm_counterCtrl_C.c}

\para{Anstossen der FSM} 
\lstinputlisting[aboveskip=0mm]{snippets/fsm_procedural_C/fsm_main_counterTest_C.c}
...
\begin{minipage}[t]{0.44\columnwidth}
    \para{Schnittstelle Counter} 
    \lstinputlisting[aboveskip=0mm]{snippets/fsm_procedural_CPP/fsm_Counter_CPP.h}
\end{minipage}
\hfill
\begin{minipage}[t]{0.52\columnwidth}
    \para{Implementation Counter} 
    \lstinputlisting[aboveskip=0mm]{snippets/fsm_procedural_CPP/fsm_Counter_CPP.cpp}
\end{minipage}


\para{Schnittstelle FSM} 
\lstinputlisting[aboveskip=0mm]{snippets/fsm_procedural_CPP/fsm_CounterCtrl_CPP.h} 

\para{Implementation FSM} 
\lstinputlisting[aboveskip=0mm]{snippets/fsm_procedural_CPP/fsm_CounterCtrl_CPP.cpp}

\columnbreak

\para{Anstossen der FSM} 
\lstinputlisting[aboveskip=0mm]{snippets/fsm_procedural_CPP/fsm_main_counterTest_CPP.cpp}
...
\begin{outline}
    ...
    \1 \textbf{Aktueller Zustand} \mylstbox{pState} wird in \textbf{privatem Attribut (Pointer!)} der Schnittstelle gehalten
        \2 Es braucht daher in der \mytclstbox{Context}-Klasse eine \textbf{forward declaration} der \mytclstbox{State}-Klasse
    \1 Die FSM wird in \textbf{zwei Funktionen} implementiert
        \2 Kontruktor (hier: \mylstbox{CounterCtrl::CounterCtrl(int initValue=0)})
        \2 Prozess-Funktion (hier: \mylstbox{void CounterCtrl::process(CounterCtrl::Event e)}) \\
            \textrightarrow\ Zustände prüfen, Zustandsübergänge veranlassen
...
\lstinputlisting[aboveskip=0mm]{snippets/fsm_state_pattern_CPP/fsm_CounterCtrl_state_pattern.h}  % OK

\para{Implementation der FSM} 
\lstinputlisting[aboveskip=0mm]{snippets/fsm_state_pattern_CPP/fsm_CounterCtrl_state_pattern.cpp} %OK
...
\lstinputlisting[%
    ...
    lastline=15, 
    aboveskip=0mm]
{snippets/fsm_state_pattern_CPP/fsm_CounterState_state_pattern.h}   %OK
...
\lstinputlisting[%
    ...
    lastline=12, 
    aboveskip=0mm]
{snippets/fsm_state_pattern_CPP/fsm_CounterState_state_pattern.cpp}  % OK


\para{Schnittstelle ConcreteStateX-Klassen (IdleState)}
\lstinputlisting[aboveskip=0mm]{snippets/fsm_state_pattern_CPP/fsm_ConcreteState.h} 

\para{Implementation abstrakte ConcreteStateX-Basisklassen (IdleState)}
\lstinputlisting[aboveskip=0mm]{snippets/fsm_state_pattern_CPP/fsm_ConcreteState.cpp} 
