...
\begin{minipage}[t]{0.48\columnwidth}
    ...
    \lstinputlisting[aboveskip=1mm, morekeywords={[3], val, step}]{snippets/fsm_procedural_C/fsm_counter_C.h}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\columnwidth}
    \para{Implementation Counter} 
    \lstinputlisting[aboveskip=1mm, morekeywords={[3], val, step, countValue}]{snippets/fsm_procedural_C/fsm_counter_C.c}
\end{minipage}
...
\lstinputlisting[aboveskip=1mm, morekeywords={[3], initValue, e}, morekeywords={[2], cnt_Event}]{snippets/fsm_procedural_C/fsm_counterCtrl_C.h} 

\para{Implementation FSM} 
\lstinputlisting[aboveskip=1mm, morekeywords={[3], currentState, initValue, e}, morekeywords={[2], State, cnt_Event}]{snippets/fsm_procedural_C/fsm_counterCtrl_C.c}

\para{Anstossen der FSM} 
\lstinputlisting[aboveskip=1mm, morekeywords={[3], answer}]{snippets/fsm_procedural_C/fsm_main_counterTest_C.c}
...
\begin{minipage}[t]{0.44\columnwidth}
    \para{Schnittstelle Counter} 
    \lstinputlisting[aboveskip=1mm, morekeywords={[3], val, step, countValue}]{snippets/fsm_procedural_CPP/fsm_Counter_CPP.h}
\end{minipage}
\hfill
\begin{minipage}[t]{0.52\columnwidth}
    \para{Implementation Counter} 
    \lstinputlisting[aboveskip=1mm, morekeywords={[3], val, step, countValue}]{snippets/fsm_procedural_CPP/fsm_Counter_CPP.cpp}
\end{minipage}


\para{Schnittstelle FSM} 
\lstinputlisting[aboveskip=1mm, morekeywords={[3], initValue, e, myCounter, currentState}, morekeywords={[2], Event, State, Counter}]{snippets/fsm_procedural_CPP/fsm_CounterCtrl_CPP.h} 

\para{Implementation FSM} 
\lstinputlisting[aboveskip=1mm, morekeywords={[3], initValue, e, myCounter, currentState}, morekeywords={[2], Event, State, Counter}]{snippets/fsm_procedural_CPP/fsm_CounterCtrl_CPP.cpp}

\para{Anstossen der FSM} 
\lstinputlisting[aboveskip=1mm, firstline=1, lastline=11, morekeywords={[3], answer, myFSM}, morekeywords={[2], CounterCtrl}]{snippets/fsm_procedural_CPP/fsm_main_counterTest_CPP.cpp}
\columnbreak
\lstinputlisting[aboveskip=1mm, firstnumber=13, firstline=13, lastline=46, morekeywords={[3], answer}, morekeywords={[2], CounterCtrl}]{snippets/fsm_procedural_CPP/fsm_main_counterTest_CPP.cpp}
...
\para{Schnittstelle FSM} 
\lstinputlisting[aboveskip=1mm, morekeywords={[3], initValue, e, myCounter, currentState, ev, pAction, nextState}, morekeywords={[2], Event, State, Action, Transition}]{snippets/fsm_table_CPP/fsm_CounterCtrl_table_CPP.h} 

\para{Implementation FSM} 
\lstinputlisting[aboveskip=1mm, morekeywords={[3], initValue, e, myCounter, currentState, i}, morekeywords={[2], Event, State, Action, Transition}]{snippets/fsm_table_CPP/fsm_CounterCtrl_table_CPP.cpp}
...
\lstinputlisting[aboveskip=1mm, morekeywords={[3], e, pAction, pChecker, nextState, currentState}, morekeywords={[2], Event, State, Action, Transition, Checker}]{snippets/fsm_table_CPP/fsm_CounterCtrl_table_pChecker_CPP.h}
...
\lstinputlisting[aboveskip=1mm, morekeywords={[3], initValue, e, entity, pState}, morekeywords={[2], Event, Counter, CounterState}]{snippets/fsm_state_pattern_CPP/fsm_CounterCtrl_state_pattern.h}

\para{Implementation der FSM} 
\lstinputlisting[aboveskip=1mm, morekeywords={[3], initValue, e, entity, pState}, morekeywords={[2], Event, Counter, CounterState}]{snippets/fsm_state_pattern_CPP/fsm_CounterCtrl_state_pattern.cpp}

\columnbreak


\para{Schnittstelle abstrakte State-Basisklasse}   
\lstinputlisting[aboveskip=1mm, morekeywords={[3], initValue, e, entity, pState, pnewState, ptransAction, CounterState}, morekeywords={[2], Event, Counter, Action}]{snippets/fsm_state_pattern_CPP/fsm_CounterState_state_pattern.h}

\para{Implementation abstrakte State-Basisklasse}
\lstinputlisting[aboveskip=1mm, morekeywords={[3], initValue, e, entity, pState, initState, pnewState, ptransAction}, morekeywords={[2], Event, Counter, CounterState, Action}]{snippets/fsm_state_pattern_CPP/fsm_CounterState_state_pattern.cpp}


\para{Schnittstelle ConcreteStateX-Klassen (CountUpState)}
\lstinputlisting[aboveskip=1mm, morekeywords={[3], initValue, e, entity, pState}, morekeywords={[2], Event, Counter, CounterState}]{snippets/fsm_state_pattern_CPP/fsm_ConcreteState.h} 
...
\lstinputlisting[aboveskip=1mm, morekeywords={[3], instance, entity, e}, morekeywords={[2], Event, Counter, CounterState}]{snippets/fsm_state_pattern_CPP/fsm_ConcreteState_with_actions.cpp} 
